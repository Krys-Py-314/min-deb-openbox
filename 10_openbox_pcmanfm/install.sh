...
# Install packages
echo "--------------------------------------------------------------------"
echo "                    10_openbox_pcmanfm.                             "
echo "--------------------------------------------------------------------"

echo -e "\e[1mInstalling packages...\e[0m"
[ "$(find /var/cache/apt/pkgcache.bin -mtime 0 2>/dev/null)" ] || apt-get update  
#apt-get install -y thunar thunar-archive-plugin thunar-media-tags-plugin catfish udisks2 ntfs-3g dosfstools exfatprogs gvfs
...
update-alternatives --install /usr/bin/x-file-manager x-file-manager /usr/bin/pcmanfm 90
