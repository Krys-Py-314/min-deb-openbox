...
wget https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.1/0xProto.zip 2> /dev/null
wget https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.1/Inconsolata.zip 2> /dev/null
wget https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.1/Iosevka.zip 2> /dev/null
wget https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.1/IosevkaTerm.zip 2> /dev/null
wget https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.1/JetBrainsMono.zip 2> /dev/null
wget https://github.com/ryanoasis/nerd-fonts/releases/download/v3.5.1/UbuntuMono.zip 2> /dev/null
